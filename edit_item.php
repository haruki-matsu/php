...
<body class=display>
    ...
    <form enctype="multipart/form-data" action="update_item.php" method="post">
        ...
        <table class=table_manage>
            ...
            <tr>
                <td><input class=input_gray name="line_up" id="line_up" value="<?php echo h($file[0]); ?>" class=input_gray1></td>
                <td><input class=input_gray name="service_content" id="service-content" value="<?php echo h($file[1]); ?>"></td>
                <td><input class=input_gray name="price" type="number" id="service-charge" value="<?php echo h($file[2]); ?>"></td>
                <td id="image_preview"><img src="<?php echo h($file[3]); ?>" alt="画像"></td>      
